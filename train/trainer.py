...
class FasterRCNNTrainer:
    ...
    def __init__(self, cfg):
        ...
        # Initialize model
        self.model = models.detection.fasterrcnn_resnet50_fpn(pretrained=True, num_classes=cfg.num_classes)
    ...
    def train(self):
        """Train the model"""
        print(f"Training Faster R-CNN model for {self.cfg.epochs} epochs")
        ...
        # Save model
        save_path = f"{self.cfg.save_dir}/fasterrcnn_model.pth"
