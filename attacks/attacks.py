...
class FasterRCNNAttacks:
    """Faster R-CNN Attack implementation"""
    ...
    def get_dataloader(self):
        ...
        dataset = FasterRCNNDataset(self.cfg.data_path, transform=self.transform)
    ...
    def _calculate_detection_loss(self, outputs, images):
        ...
        # For Faster R-CNN, outputs is a list of dicts with 'boxes', 'labels', 'scores'
