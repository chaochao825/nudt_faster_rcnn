...
from fasterrcnn_detector.main import main as fasterrcnn_main
...
def parse_args():
    ...
    parser.add_argument('--model', type=str, default='fasterrcnn', help='model name [fasterrcnn]')
...
def main(args):
    args, cfg = fasterrcnn_cfg(args)
    fasterrcnn_main(args, cfg)
